...
## Purpose
A local coding-agent skill (v0.7.2, public beta) with two independent modes. **Plan** runs two
...
| `VERSION` | Single source of truth for the release version (`0.7.2`). The release gate rejects drift against SKILL.md, README.md, CHANGELOG.md, and `scripts/plan_workflow.py`. |
